                    ...
                    <div className="absolute inset-0 pt-10 flex flex-col">
                      ...
                      <div className="flex items-start justify-between px-4 mb-3">
                        <div>
                          ...
                          <p className="text-gray-400 dark:text-white/30 text-[9px] mt-0.5 ml-[26px]">Provided by Sabil</p>
                        </div>
                      ...
                      <div className="mx-4 bg-gradient-to-br from-[#0d4a3a] to-[#0a3028] rounded-2xl p-3.5 mb-3 relative overflow-hidden cursor-pointer hover:from-[#0f5544] hover:to-[#0c3830] hover:shadow-lg hover:shadow-sabil/10 active:scale-[0.98] transition-all duration-200">
                        ...
                        <p className="text-white/50 text-[10px]">Sabil principal</p>
                      </div>
                      ...
                      <div className="mx-4 flex items-center gap-2 mb-3">
                        <button className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/[0.06] cursor-pointer hover:bg-sabil/10 hover:border-sabil/20 active:scale-95 transition-all duration-200 group">
                          ...
                          <span className="text-gray-700 dark:text-white/70 text-[10px] font-medium group-hover:text-sabil transition-colors">Transfer</span>
                        </button>
                        ...
                        <button className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/[0.06] cursor-pointer hover:bg-sabil/10 hover:border-sabil/20 active:scale-95 transition-all duration-200 group">
                          ...
                          <span className="text-gray-700 dark:text-white/70 text-[10px] font-medium group-hover:text-sabil transition-colors">Spend</span>
                        </button>
                      </div>

                      {/* Notifications */}
                      <div className="flex-1 px-4 overflow-hidden">
                        <p className="text-gray-500 dark:text-white/30 text-[10px] font-medium mb-2">Notifications</p>
                        <div className="space-y-2">
                          {[
                            { title: "Recharge Successful", desc: "Ooredoo +500 DA", time: "2m ago", unread: true, color: "bg-sabil/10", iconColor: "text-sabil", icon: "M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
                            { title: "Transfer Received", desc: "From Ahmed K. +2,000 DA", time: "1h ago", unread: true, color: "bg-blue-500/10", iconColor: "text-blue-400", icon: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" },
                            { title: "Bill Payment", desc: "Sonelgaz -1,200 DA", time: "3h ago", unread: false, color: "bg-orange-500/10", iconColor: "text-orange-400", icon: "M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
                            { title: "Promo Offer", desc: "50% off on Mobilis recharge", time: "5h ago", unread: false, color: "bg-purple-500/10", iconColor: "text-purple-400", icon: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" },
                            { title: "Card Activated", desc: "Your virtual card is ready", time: "1d ago", unread: false, color: "bg-emerald-500/10", iconColor: "text-emerald-400", icon: "M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" },
                          ].map((notif) => (
                            <div
                              key={notif.title}
                      ...
                      <div className="px-2 pb-2 pt-1">
                        <div className="flex items-center justify-around py-2 border-t border-gray-200 dark:border-white/[0.06]">
                          {[
                            { label: "Home", active: true, badge: 0, icon: "M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" },
                            { label: "Services", active: false, badge: -1, icon: "M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zm0 9.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zm9.75-9.75A2.25 2.25 0 0115.75 3.75H18a2.25 2.25 0 012.25 2.25v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zm0 9.75a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 15.75V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" },
                            { label: "Chat", active: false, badge: 2, icon: "M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" },
                            { label: "Account", active: false, badge: 0, icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" },
                          ].map((nav) => (
