...
const servicesList: ServiceDef[] = [
  { key: "ade", category: "bills", color: "#3B82F6", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A11.978 11.978 0 0112 16.5c-3.44 0-6.564-1.45-8.716-3.747" /></svg> },
  { key: "agentForm", category: "other", color: "#10B981", icon: <ClipboardDocumentListIcon className="h-6 w-6" /> },
  { key: "agents", category: "finance", color: "#8B5CF6", icon: <UserGroupIcon className="h-6 w-6" /> },
  { key: "atFactures", category: "telecom", color: "#06B6D4", icon: <SignalIcon className="h-6 w-6" /> },
  { key: "cib", category: "finance", color: "#F59E0B", icon: <CreditCardIcon className="h-6 w-6" /> },
  { key: "facilite", category: "finance", color: "#EF4444", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg> },
  { key: "flexy", category: "telecom", color: "#10B981", icon: <DevicePhoneMobileIcon className="h-6 w-6" /> },
  { key: "carteCadeaux", category: "other", color: "#EC4899", icon: <GiftIcon className="h-6 w-6" /> },
  { key: "internet", category: "telecom", color: "#6366F1", icon: <GlobeAltIcon className="h-6 w-6" /> },
  { key: "servicesShop", category: "other", color: "#F97316", icon: <ShoppingCartIcon className="h-6 w-6" /> },
  { key: "iptv", category: "telecom", color: "#14B8A6", icon: <TvIcon className="h-6 w-6" /> },
  { key: "sabilPos", category: "finance", color: "#00FF95", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72" /></svg> },
  { key: "seaal", category: "bills", color: "#0EA5E9", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg> },
  { key: "sonelgaz", category: "bills", color: "#F97316", icon: <BoltIcon className="h-6 w-6" /> },
  { key: "timbresFiscaux", category: "bills", color: "#8B5CF6", icon: <DocumentTextIcon className="h-6 w-6" /> },
  { key: "vignetteAuto", category: "transport", color: "#EF4444", icon: <TruckIcon className="h-6 w-6" /> },
  { key: "eVoucher", category: "finance", color: "#10B981", icon: <TicketIcon className="h-6 w-6" /> },
  { key: "zteBonus", category: "other", color: "#3B82F6", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" /></svg> },
  { key: "zteScan", category: "other", color: "#6366F1", icon: <QrCodeIcon className="h-6 w-6" /> },
  { key: "zteSignup", category: "other", color: "#14B8A6", icon: <UserPlusIcon className="h-6 w-6" /> },
  { key: "gestimmo", category: "bills", color: "#F59E0B", icon: <BuildingOfficeIcon className="h-6 w-6" /> },
  { key: "seor", category: "bills", color: "#0EA5E9", icon: <BuildingLibraryIcon className="h-6 w-6" /> },
  { key: "sogral", category: "transport", color: "#8B5CF6", icon: <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" /></svg> },
];
